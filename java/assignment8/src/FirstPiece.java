...
/**
 * The FirstPiece class represents a piece that can be drawn on a board. It extends the Pieces class.
 *
 * @author Sukhmanjeet Singh, Student ID 000838215
 */
public class FirstPiece extends Pieces {

    /**
     * Constructs a new FirstPiece object with the given size and color.
     *
     * @param size  The size of the piece.
     * @param color The color of the piece.
     */
    public FirstPiece(double size, Color color) { // declare a public constructor for FirstPiece that takes a double size and a Color color as arguments
    ...
    public String toString() { // override the toString method of the superclass
        return "FirstPiece{} " + super.toString(); // return a string representation of the object that includes "FirstPiece{}" and the result of calling the superclass's toString method
    }
}
